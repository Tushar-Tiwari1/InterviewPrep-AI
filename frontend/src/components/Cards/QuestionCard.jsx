          ...
          <div className="flex items-start justify-between cursor-pointer">
           ...
           <div className="flex items-center justify-end ml-4 relative">
              <div
               ...
               <button
                className="flex items-center gap-2 text-xs text-indigo-50 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-50 hover:border-indigo-200 cursor-pointer"
                onClick={onTogglePin}
                >
                    {isPinned ? (
                ...
                <button
                 ...
                 >
                    <LuSparkles/>
                    <span className="hiddden md:block">Learn More</span>
                 </button>
